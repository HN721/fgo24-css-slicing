...
const getData = JSON.parse(localStorage.getItem("transfers"));
getData.forEach((element) => {
  const a = document.createElement("a");
  a.classList.add("list-trans1");

  a.innerHTML = `
  <img src="${element.image}" alt="Foto" />
  <p>${element.name}</p>
  <p>${element.phone}</p>
  <p class="p-red">Rp. ${element.amount}</p>
  <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M20.75 5.25L4.25 5.25001" stroke="#4F5665" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    ...
    <path d="M19.25 5.25V19.5C19.25 19.6989 19.171 19.8897 19.0303 20.0303C18.8897 20.171 18.6989 20.25 18.5 20.25H6.5C6.30109 20.25 6.11032 20.171 5.96967 20.0303C5.82902 19.8897 5.75 19.6989 5.75 19.5V5.25" stroke="#D00000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
